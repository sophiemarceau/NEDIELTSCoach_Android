package com.lelts.schedule.calendar;
...
//	private int clickFlag = -1;// 用于标记点击位置
	...
	public CalendarView(Context context, Resources rs, int jumpMonth,
			...
			HashMap<String, Object> map_test) {
...
//		Log.e("ocean", "   ++++++++ currentFlag = " + currentFlag);
...
//					System.out.println("222");
					...
					/*SpannableStringBuilder mSpannableStringBuilder=new SpannableStringBuilder(currentDay); 
			        mSpannableStringBuilder.setSpan
			        (new ForegroundColorSpan(Color.RED), 0, 1, Spannable.SPAN_EXCLUSIVE_INCLUSIVE);*/
					// 设置当天的背景
					holder.tView.setTextColor(Color.WHITE);
					holder.iv_day
							.setBackgroundResource(R.drawable.calendar_background_red);
//					System.out.println("333"+"--"+currentDay);
				}
...
//					String test = "2015-10-10";
			...
			if (currentFlag == position) {
				...
				holder.tView.setTextColor(context.getResources().getColor(
						R.color.white));
				System.out.println("xia----22222");
				if (c_position == position) {
					System.out.println("当前日期背景为null");
					holder.tView.setTextColor(Color.RED);
					holder.tView.setBackgroundColor(Color.WHITE);
					System.out.println("xia----33333");
				}
